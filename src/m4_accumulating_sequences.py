...
def run_test_make_simple_list():
    ...
    expected = [13,14,15,16,17,18]
    actual = make_simple_list(13, 18)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '13-14-15-16-17-18-'
    actual = make_simple_string (13, 18)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '13-14-15-16-17-18'
    actual = make_less_simple_string(13, 18)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        x= circle_center.x
        y=circle_center.y
        corner1=rg.Point(x-r,y-r)
        corner2=rg.Point(x+r,y+r)
